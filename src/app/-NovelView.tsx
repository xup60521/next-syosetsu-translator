...
export default function NovelView({
    ...
    const query = api.serverFunction.novelHandler.useQuery({ url: selectedNovelURL ?? "" }, { enabled: !!selectedNovelURL })
...
function SidePanel({
    ...
    const { isLoading, error, data } = api.serverFunction.decomposeUrl.useQuery({ url_string }, { enabled: !!url_string })
