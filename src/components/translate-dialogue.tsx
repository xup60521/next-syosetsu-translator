...
import type { DecomposedURL } from "@/server/api/routers/server-function";
import { useApikeyQuery } from "@/client-query/apikeyQuery";
...
function TranlationForm({
    ...
    const modelListQuery = api.serverFunction.getModelList.useQuery(form.watch("provider"), { enabled: !!form.watch("provider") })
    ...
    const submitTranslationMutation = api.serverFunction.translate.useMutation({
        onSuccess: () => {
